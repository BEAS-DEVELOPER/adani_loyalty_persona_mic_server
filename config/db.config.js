...
db.basicProfile = require('../src/models/basicProfileModel')(sequelize, DataTypes)
db.parentChildMapping = require('../src/models/contactParentChildMapping')(sequelize, DataTypes)
...
db.userFile=require('../src/models/userFileModel')(sequelize, DataTypes)
